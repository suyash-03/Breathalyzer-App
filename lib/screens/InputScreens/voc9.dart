...
class VOC9 extends StatefulWidget {
  final InputController inputController;
  final PageController pageController;
  const VOC9({Key? key, required this.inputController,required this.pageController}) : super(key: key);

  @override
  State<VOC9> createState() => _VOC9State();
}

class _VOC9State extends State<VOC9> {
  List<bool> selectionList = List.filled(20, false);

  @override
  void initState() {
    if(widget.inputController.refillList[8] != -1){
      int k = widget.inputController.refillList[8];
    ...
    return ListView(
      ...
      children: [
        Padding(
          ...
          child: Text("VOC 9",style: GoogleFonts.poppins(fontSize: 22,color: Colors.white),),
        ),
        Row(
          children: [
            Flexible(
            ...
            onTapUp: (){
              ...
              for(int i=0; i <selectionList.length; i++){
                if(selectionList[i] == true){
                  widget.inputController.vocChoiceList[8] = widget.inputController.vocDataList[i];
                  widget.inputController.refillList[8] = i;
                  print(widget.inputController.vocChoiceList[8]);
                  break;
                }
              }
