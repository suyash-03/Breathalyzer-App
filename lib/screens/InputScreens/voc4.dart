...
class _VOC4State extends State<VOC4> {
  ...
  @override
  void initState() {
    if(widget.inputController.refillList[3] != -1){
      int k = widget.inputController.refillList[3];
            ...
            onTapUp: (){
              ...
              for(int i=0; i <selectionList.length; i++){
                if(selectionList[i] == true){
                  widget.inputController.vocChoiceList[3] = widget.inputController.vocDataList[i];
                  widget.inputController.refillList[3] = i;
                  print(widget.inputController.vocChoiceList[3]);
                  break;
                }
              }
