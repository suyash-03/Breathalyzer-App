...
class VOC2 extends StatefulWidget {
  final InputController inputController;
  final PageController pageController;
  const VOC2({Key? key, required this.inputController,required this.pageController}) : super(key: key);

  @override
  State<VOC2> createState() => _VOC2State();
}
...
class _VOC2State extends State<VOC2> {
  ...
  @override
  void initState() {
    if(widget.inputController.refillList[1] != -1){
      int k = widget.inputController.refillList[1];
    ...
    return ListView(
      ...
      children: [
        Padding(
          ...
          child: Text("VOC 2",style: GoogleFonts.poppins(fontSize: 22,color: Colors.white),),
        ),
        Row(
          children: [
            Flexible(
            ...
            onTapUp: (){
              ...
              for(int i=0; i <selectionList.length; i++){
                if(selectionList[i] == true){
                  widget.inputController.vocChoiceList[1] = widget.inputController.vocDataList[i];
                  widget.inputController.refillList[1] = i;
                  print(widget.inputController.vocChoiceList[1]);
                  break;
                }
              }
