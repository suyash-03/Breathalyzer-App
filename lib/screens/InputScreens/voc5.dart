...
class VOC5 extends StatefulWidget {
  final InputController inputController;
  final PageController pageController;
  const VOC5({Key? key, required this.inputController,required this.pageController}) : super(key: key);

  @override
  State<VOC5> createState() => _VOC5State();
}

class _VOC5State extends State<VOC5> {
  List<bool> selectionList = List.filled(20, false);

  @override
  void initState() {
    if(widget.inputController.refillList[4] != -1){
      int k = widget.inputController.refillList[4];
    ...
    return ListView(
      ...
      children: [
        Padding(
          ...
          child: Text("VOC 5",style: GoogleFonts.poppins(fontSize: 22,color: Colors.white),),
        ),
        Row(
          children: [
            Flexible(
            ...
            onTapUp: (){
              ...
              for(int i=0; i <selectionList.length; i++){
                if(selectionList[i] == true){
                  widget.inputController.vocChoiceList[4] = widget.inputController.vocDataList[i];
                  widget.inputController.refillList[4] = i;
                  print(widget.inputController.vocChoiceList[4]);
                  break;
                }
              }
