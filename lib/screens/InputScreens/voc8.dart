...
class VOC8 extends StatefulWidget {
  final InputController inputController;
  final PageController pageController;
  const VOC8({Key? key, required this.inputController,required this.pageController}) : super(key: key);

  @override
  State<VOC8> createState() => _VOC8State();
}
    ...
    return ListView(
      ...
      children: [
        Padding(
          ...
          child: Text("VOC 8",style: GoogleFonts.poppins(fontSize: 22,color: Colors.white),),
        ),
        Row(
          children: [
            Flexible(
