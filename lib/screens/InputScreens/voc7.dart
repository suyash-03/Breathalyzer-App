...
class VOC7 extends StatefulWidget {
  final InputController inputController;
  final PageController pageController;
  const VOC7({Key? key, required this.inputController,required this.pageController}) : super(key: key);

  @override
  State<VOC7> createState() => _VOC7State();
}
...
class _VOC7State extends State<VOC7> {
  ...
  @override
  void initState() {
    if(widget.inputController.refillList[6] != -1){
      int k = widget.inputController.refillList[6];
    ...
    return ListView(
      ...
      children: [
        Padding(
          ...
          child: Text("VOC 7",style: GoogleFonts.poppins(fontSize: 22,color: Colors.white),),
        ),
        Row(
          children: [
            Flexible(
            ...
            onTapUp: (){
              ...
              for(int i=0; i <selectionList.length; i++){
                if(selectionList[i] == true){
                  widget.inputController.vocChoiceList[6] = widget.inputController.vocDataList[i];
                  widget.inputController.refillList[6] = i;
                  print(widget.inputController.vocChoiceList[6]);
                  break;
                }
              }
