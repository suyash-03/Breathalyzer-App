...
class VOC13 extends StatefulWidget {
  final InputController inputController;
  final PageController pageController;
  const VOC13({Key? key, required this.inputController,required this.pageController}) : super(key: key);

  @override
  State<VOC13> createState() => _VOC13State();
}
    ...
    return ListView(
      ...
      children: [
        Padding(
          ...
          child: Text("VOC 13",style: GoogleFonts.poppins(fontSize: 22,color: Colors.white),),
        ),
        Row(
          children: [
            Flexible(
