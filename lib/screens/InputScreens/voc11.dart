...
class VOC11 extends StatefulWidget {
  final InputController inputController;
  final PageController pageController;
  const VOC11({Key? key, required this.inputController,required this.pageController}) : super(key: key);

  @override
  State<VOC11> createState() => _VOC11State();
}

class _VOC11State extends State<VOC11> {
  List<bool> selectionList = List.filled(20, false);

  @override
  void initState() {
    if(widget.inputController.refillList[10] != -1){
      int k = widget.inputController.refillList[10];
    ...
    return ListView(
      ...
      children: [
        Padding(
          ...
          child: Text("VOC 11",style: GoogleFonts.poppins(fontSize: 22,color: Colors.white),),
        ),
        Row(
          children: [
            Flexible(
            ...
            onTapUp: (){
              ...
              for(int i=0; i <selectionList.length; i++){
                if(selectionList[i] == true){
                  widget.inputController.vocChoiceList[10] = widget.inputController.vocDataList[i];
                  widget.inputController.refillList[10] = i;
                  print(widget.inputController.vocChoiceList[10]);
                  break;
                }
              }
