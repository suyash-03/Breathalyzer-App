...
class VOC12 extends StatefulWidget {
  final InputController inputController;
  final PageController pageController;
  const VOC12({Key? key, required this.inputController,required this.pageController}) : super(key: key);

  @override
  State<VOC12> createState() => _VOC12State();
}

class _VOC12State extends State<VOC12> {
  List<bool> selectionList = List.filled(19, false);

  @override
  void initState() {
    if(widget.inputController.refillList[11] != -1){
      int k = widget.inputController.refillList[11];
    ...
    return ListView(
      ...
      children: [
        Padding(
          ...
          child: Text("VOC 12",style: GoogleFonts.poppins(fontSize: 22,color: Colors.white),),
        ),
        Row(
          children: [
            Flexible(
            ...
            onTapUp: (){
              ...
              for(int i=0; i <selectionList.length; i++){
                if(selectionList[i] == true){
                  widget.inputController.vocChoiceList[11] = widget.inputController.vocDataList[i];
                  widget.inputController.refillList[11] = i;
                  print(widget.inputController.vocChoiceList[11]);
                  break;
                }
              }
